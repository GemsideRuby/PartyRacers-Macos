...
#define MAXVIDWIDTH 2560 // don't set this too high because actually				//SCS - RADIO
#define MAXVIDHEIGHT 1440 // lots of tables are allocated with the MAX size.		//SCS - RADIO
