...
static void M_PlayerMuteHandler(INT32 choice)													//SCS - RADIO START
{
	const UINT8 pid = 0;
...
void M_KickHandler(INT32 choice)
{
	...
	playerkickmenu.purpose = PKM_KICK; // RadioRacers: The purpose of the menu is to KICK players.			//SCS - RADIO
